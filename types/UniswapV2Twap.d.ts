...
interface UniswapV2TwapInterface extends ethers.utils.Interface {
  functions: {
    "consult(address,uint256,address)": FunctionFragment;
    "factory()": FunctionFragment;
    "getFirstObservationInWindow2(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getFirstObservationInWindow2",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class UniswapV2Twap extends Contract {
  ...
  interface: UniswapV2TwapInterface;
  ...
  functions: {
    ...
    getFirstObservationInWindow2(
      ...
      [
        ...
        firstObservation: [BigNumber, BigNumber, BigNumber] & {
          timestamp: BigNumber;
          price0Cumulative: BigNumber;
          price1Cumulative: BigNumber;
        };
    ...
    "getFirstObservationInWindow2(address)"(
      pair: string,
      overrides?: CallOverrides
    ): Promise<
      [
    ...
    "getTimeElapsed(address,address)"(
      tokenIn: string,
      tokenOut: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
